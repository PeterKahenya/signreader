...
def create_and_train_model(classes,classes_count,t_images_count,v_images_count,train_batches=10,validate_batches=10):
    ...
    model.fit_generator(train_batch,steps_per_epoch=t_batches_per_epoch,validation_data=validate_batch,validation_steps=v_images_count,epochs=20,verbose=1)
